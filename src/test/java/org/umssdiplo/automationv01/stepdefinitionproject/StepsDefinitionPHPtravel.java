...
//    }
    ...
    @Given("^'Configuracion' page is loaded$")
    public void configuracionPageIsLoaded() {
        login = LoadPage.loginPage();
    }

    @And("^click 'Registrar Maquinaria' button in 'header-right' page$")
    public void clickRegistrarMaquinariaButtonInHeaderRightPage() {
        login.clickButtonAdd();
    }
}
